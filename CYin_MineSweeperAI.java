...
public class CYin_MineSweeperAI extends JFrame implements ActionListener, MouseListener{
    int rows = 10, cols = 10;
    int mineNum = 10;
    ...
    JMenuItem autoPlay = new JMenuItem("Auto Play");
    ...
    public static void main (String []args){
        new CYin_MineSweeperAI();
    }

    public CYin_MineSweeperAI(){
